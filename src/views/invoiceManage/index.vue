    ...
    <!-- 发票管理 -->
     <el-row class="row-bg" :gutter="10">
        <el-col :span="5" class="col-bg">
          订单编号：<el-input style="width:170px" v-model="orderNumber" @keyup.enter.native="search()"></el-input>
        </el-col>
        <el-col :span="4" class="col-bg">
          昵称：<el-input style="width:150px" v-model="nickName" @keyup.enter.native="search()"></el-input>
        </el-col>
        <el-col :span="5" class="col-bg">
          公司抬头：<el-input style="width:170px" v-model="letterHead" @keyup.enter.native="search()"></el-input>
        </el-col>
        <el-col :span="4" class="col-bg">
          类型：<el-select v-model="orderType" placeholder="请选择" style="width:150px;" filterable>
            <el-option
              v-for="item in type"
              :key="item.value"
              :label="item.label"
        ...
        <el-col :span="5" class="col-bg">
          纳税人识别号：<el-input style="width:150px" v-model="identifier" @keyup.enter.native="search()"></el-input>
        </el-col>
        <el-col :span="5" class="col-bg">
          订单状态：<el-select v-model="orderStatus" placeholder="请选择" style="width:170px;" filterable>
            <el-option
        ...
        <el-col :span="4" class="col-bg">
          备注：<el-select v-model="orderRemark" placeholder="请选择" style="width:150px;" filterable>
            <el-option
